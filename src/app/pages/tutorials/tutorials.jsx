...
import InstitutionTutorialPage from './tutorialsinstitutions';
import StudentTutorialPage from './tutorialsstudents';
import '../../globals.css';
...
const Tutorials = () => {
  ...
  // Persistent Header Component - Only dark mode colors
  const Header = () => (
    <header className="sticky top-0 z-50 bg-gray-800 border-gray-700 border-b backdrop-blur-sm bg-opacity-95">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            >
              <BookOpen className="text-[#2A9D8F] mr-3" size={32} />
              Instipass Tutorials
            </button>
            ...
            {currentPage !== 'home' && (
              <div className="flex items-center space-x-2">
                ...
                <div className="flex bg-gray-700 rounded-lg p-1">
                  ...
                  >
                    <University size={16} className="inline mr-1" />
                    Institution
                  </button>
                  <button
                    ...
                    className={`px-3 py-1 rounded-md text-sm font-medium transition-all ${
                      currentPage === 'student'
                        ? 'bg-gray-600 shadow-sm text-[#2A9D8F]'
                        : 'text-gray-300 hover:text-[#2A9D8F]'
                    }`}
                  >
